...
<template>
    ...
    <!-- Sidebar -->
        <aside :class="[
          ...
          'bg-white border-r border-gray-200 h-screen overflow-y-auto transition-all duration-300 fixed md:relative z-40'
        ]">
    ...
    <div class="flex-1 flex flex-col h-screen">
      <!-- Top bar -->
      <header class="fixed top-0 left-0 right-0 bg-white shadow-sm h-[68px] px-2 py-8 flex justify-between items-center border-b border-gray-sparktro z-50"
      ...
      <!-- Main Section -->
      <main class="p-6 bg-gray-sparktro mt-[68px]">
        <slot />
      </main>
    </div>
  </div>
